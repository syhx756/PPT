import {
  ...
  preloadConcurrency,
  rankImageCandidates
} from "./assets/runtime/image-preload-policy.mjs?v=e8b1140daf20";
...
const projects = {
  shanhaitu: {
    ...
    title: "《山海图》系列 IP",
    type: "国风神话 × 科幻 × 探险",
    image: "assets/projects/shanhaitu-overview.webp?v=e8b1140daf20",
    cycle: "单部3个月制作周期",
    producer: "当康文化",
    platform: "院线 / 流媒体",
    heat: "核心 IP 储备",
  ...
  jueditian: {
    ...
    title: "《绝地天通》",
    type: "上古神话 / 奇幻冒险",
    image: "assets/projects/jueditian-page16.webp?v=e8b1140daf20",
    cycle: "先导片阶段",
    producer: "当康文化",
    platform: "院线 / 国际电影节",
    heat: "重点筹备",
  ...
  terminal: {
    ...
    title: "《终极》",
    type: "近未来科幻 / 无限流 / 惊悚冒险",
    image: "assets/projects/terminal-hd.webp?v=e8b1140daf20",
    cycle: "概念开发阶段",
    producer: "当康文化",
    platform: "院线 / 流媒体",
    heat: "开发中",
  ...
  golden: {
    ...
    title: "《黄金帐》",
    type: "现代探险 / 历史悬疑 / 古今双魂",
    image: "assets/projects/golden-page31.webp?v=e8b1140daf20",
    cycle: "世界观开发阶段",
    producer: "当康文化",
    platform: "院线 / 流媒体",
    heat: "系列储备",
  ...
  star: {
    ...
    title: "《星途璀璨》",
    type: "真人互动影像 / 电影级分支叙事",
    image: "assets/projects/star.webp?v=e8b1140daf20",
    cycle: "互动剧开发阶段",
    producer: "当康文化",
    platform: "互动影游平台",
    heat: "重点项目",
  ...
  projection: {
    ...
    title: "《投影》",
    type: "国风赛博 / 轻喜科幻",
    image: "assets/projects/projection-hd.webp?v=e8b1140daf20",
    cycle: "剧本开发阶段",
    producer: "当康文化",
    platform: "流媒体 / 文旅场景",
    heat: "原创储备",
  ...
  dongfang: {
    ...
    title: "《东方朔》",
    type: "历史轻喜 / 弹幕互动",
    image: "assets/projects/dongfang.webp?v=e8b1140daf20",
    cycle: "方案开发阶段",
    producer: "当康文化",
    platform: "短剧平台 / 文旅场景",
    heat: "项目筹备",
  ...
  liaozhai: {
    ...
    title: "《聊斋诡事录》",
    type: "全息沉浸 / 狐族志异 / 情感冒险",
    image: "assets/projects/liaozhai.webp?v=e8b1140daf20",
    cycle: "互动内容开发阶段",
    producer: "当康文化",
    platform: "沉浸娱乐 / 互动影游",
    heat: "项目储备",
...
function registerTeamOriginals(root = document) {
  root.querySelectorAll(".team-card[data-member-index]").forEach(card => {
    ...
    if (member?.photo) registerImageCandidate(`assets/team/${member.photo}.webp?v=e8b1140daf20`, { anchor: card });
  });
  scheduleImageWork();
}
...
function openTeam(index) {
  ...
  teamModalVisual.innerHTML = member.photo
    ? `<img src="assets/team/${member.photo}.webp?v=e8b1140daf20" alt="${member.name}团队资料">`
...
function renderTeam(filter = "all") {
  ...
  rail.innerHTML = entries.map((member, index) => {
    ...
    const visual = member.photo
          ? `<img data-src="assets/team/thumbs/${member.photo}.webp?v=e8b1140daf20" alt="${member.name}团队资料" loading="lazy" decoding="async">`
